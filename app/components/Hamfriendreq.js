        ...
        <div className={`h-[100vh] z-40 bg-black border-1 border-gray-800 text-white flex absolute right-[0]  transition-transform duration-900 ease-in-out transform ${bool ? 'translate-x-0 w-[30vw]' : 'translate-x-full w-[0vw]'} `}>
            {bool && (
                <ul className=' gap-6'>
                    ...
                    <li className=' border-1 border-gray-800 flex w-[30vw]  cursor-pointer px-2 py-4 hover:bg-gray-500 bg-black custom-font'><Link href="/dashboard"><div className='flex justify-center items-center gap-5'><img src="/wired-outline-955-demand-hover-roll.gif" className='w-[3vw]' /><p>My Groups</p></div></Link></li>
                    ...
                    <li className=' border-1 border-gray-800 flex w-[30vw]  cursor-pointer px-2 py-4 bg-gray-500 custom-font'><Link href="/dashboard/friendreq"><div className='flex justify-center items-center gap-5  text-white'><img src="/add-friend.png" className='w-[3vw] invert-100' /><p className='text-white'>Friend Requests</p></div></Link></li>
                                        <li className='bg-black border-1 border-gray-800 flex w-[30vw]  cursor-pointer px-2 py-4 hover:bg-gray-500 custom-font'><Link href="/dashboard/friends"><div className='flex justify-center items-center gap-5  text-white'><img src="/add-friend.png" className='w-[3vw] invert-100' /><p className='text-white'>Friends</p></div></Link></li>
